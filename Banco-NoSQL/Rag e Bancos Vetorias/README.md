...
Bancos Vetoriais (Qdrant) Pesquisei sobre o Qdrant, que é onde esses números (vetores) ficam guardados. Ele funciona como uma biblioteca que acha o conteúdo por contexto. Se eu pergunto sobre saúde, ele sabe que deve buscar trechos que falem de bem-estar ou médicos.

Ferramentas de Apoio (LangChainLangGraph) Vi que são os organizadores que conectam tudo. O LangChain faz o fluxo básico e o LangGraph permite criar lógicas mais espertas para a IA decidir o que pesquisar.
